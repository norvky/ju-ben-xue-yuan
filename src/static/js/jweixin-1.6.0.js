; ((e, n) => {
  ...
  if (!r.jWeixin)
    return (
      ...
      (s = t.indexOf('wxdebugger') != -1),
      (d = t.indexOf('micromessenger') != -1),
      (l = t.indexOf('android') != -1),
      (u = t.indexOf('iphone') != -1 || t.indexOf('ipad') != -1),
      ...
      (_ = {
        config: function (e) {
          ...
          O(function () {
            if (o)
              ...
              y.state = 1
              for (let e = S._completes, n = 0, i = e.length; n < i; ++n) e[n]()
              S._completes = []
            }
            let t
          }),
        ...
        uploadVoice: function (e) {
          k(
            'uploadVoice',
            { localId: e.localId, isShowProgressTips: e.isShowProgressTips == 0 ? 0 : 1 },
            e,
          )
        },
        downloadVoice: function (e) {
          k(
            'downloadVoice',
            { serverId: e.serverId, isShowProgressTips: e.isShowProgressTips == 0 ? 0 : 1 },
            e,
          )
        },
        ...
        function (e) {
          ...
          l ||
            ((t = (n = e.target).tagName),
              (i = n.src),
              t != 'IMG' && t != 'VIDEO' && t != 'AUDIO' && t != 'SOURCE') ||
            (i.indexOf('wxlocalresource://') != -1 &&
              (e.preventDefault(),
                e.stopPropagation(),
        ...
        function (e) {
          ...
          l ||
            ((n = (e = e.target).tagName),
              n != 'IMG' && n != 'VIDEO' && n != 'AUDIO' && n != 'SOURCE') ||
            ((n = e['wx-id']) && (T[n] = !1))
        },
        !0,
      ),
  ...
  function V(e, n, i) {
    ; (e != 'openEnterpriseChat' && e !== 'openBusinessView') || (n.errCode = n.err_code),
      delete n.err_code,
      delete n.err_desc,
      delete n.err_detail
    let t = n.errMsg
            ...
            return (
              ...
              ((i = n.indexOf(':')),
                ((t = (t = (t =
                  (t =
                    (t =
                      (t = (t = n.substring(i + 1)) == 'confirm' ? 'ok' : t) == 'failed'
                        ? 'fail'
                        : t).indexOf('failed_') != -1
                      ? t.substring(7)
                      : t).indexOf('fail_') != -1
                    ? t.substring(5)
                    : t).replace(/_/g, ' ')).toLowerCase()) != 'access denied' &&
                  t != 'no permission to execute') ||
                (t = 'permission denied'),
                (t = e == 'config' && t == 'function not exist' ? 'ok' : t) == '') &&
              (t = 'fail'),
              (n = e + ':' + t)
            )
          })(e, t)),
